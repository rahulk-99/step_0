...
"""
This script demonstrates two UR10 single-arm manipulators.
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # -- Robot
    ur10_cfg_1 = UR10_CFG.replace(prim_path="/World/Origin1/Robot")
    ur10_cfg_1.init_state.pos = (0.0, 0.0, 1.05)
    franka_panda = Articulation(cfg=ur10_cfg_1)

    # Origin 2 with UR10_2
    ...
    # -- Robot
    ur10_cfg_2 = UR10_CFG.replace(prim_path="/World/Origin2/Robot")
    ur10_cfg_2.init_state.pos = (0.0, 0.0, 1.03)
    ur10 = Articulation(cfg=ur10_cfg_2)
